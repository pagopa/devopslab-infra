...
module "key_vault_domain" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault?ref=v3.11.0"
...
#   display_name = "pagopaspa-dvopla-platform-iac-projects-${data.azurerm_subscription.current.subscription_id}"
# }
