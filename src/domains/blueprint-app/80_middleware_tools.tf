module "tls_checker" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//tls_checker?ref=v7.7.0"
  ...
  kv_secret_name_for_application_insights_connection_string = "dvopla-d-appinsights-connection-string"
