locals {
  ...
  # KeyVault
  #
  key_vault_domain_name           = "dvopla-d-marco-kv"
  key_vault_domain_resource_group = "dvopla-d-marco-sec-rg"

  #
  # Container App
  #
  container_app_marco_environment_name           = "dvopla-d-marco-cappenv"
  container_app_marco_environment_resource_group = "dvopla-d-marco-container-app-rg"
...
variable "cidr_subnet_container_apps" {
  type        = list(string)
  description = "Subnet for container apps in marco domain"
}
