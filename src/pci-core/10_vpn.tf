...
# module "vpn" {
#   source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//vpn_gateway?ref=v7.10.1"
...
#   source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//dns_forwarder?ref=v7.10.1"
