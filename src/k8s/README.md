...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_helm-template-ingress"></a> [helm-template-ingress](#module\_helm-template-ingress) | git::https://github.com/pagopa/azurerm.git//kubernetes_ingress | v2.7.0 |
